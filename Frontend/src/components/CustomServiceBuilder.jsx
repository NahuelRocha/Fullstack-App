  ...
  return (
    <div className="min-h-screen bg-gray-50 py-5 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl mt-16 md:mt-12">
        ...
        <div className="p-4 md:p-6 flex flex-col md:flex-row md:justify-between md:items-center text-center md:text-left border-b">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2">Armá tu Pedido</h2>
          ...
          <button
            ...
            className="bg-brightColor text-white px-4 py-2 md:px-6 md:py-3 rounded-xl hover:bg-opacity-90 flex items-center justify-center space-x-2 md:space-x-3 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all mt-4 md:mt-0"
          >
            <Plus className="w-4 h-4 md:w-5 md:h-5" />
            <span className="font-medium text-sm md:text-base">Agregar Productos</span>
          </button>
        </div>
        ...
        <div className="p-3 h-80">
          {selectedProducts.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-gray-500 bg-gray-50 rounded-xl border-2 border-dashed">
              <Package className="w-12 h-12 md:w-16 md:h-16 mb-4 opacity-50" />
            ...
            <div className="h-full overflow-y-auto pr-2 space-y-2">
              {selectedProducts.map(product => (
                <div
                  key={product.id}
                  className="flex items-center justify-between p-3 md:p-4 bg-gray-50 rounded-xl border-2 hover:border-brightColor transition-colors"
                >
                  ...
                  <div className="flex items-center space-x-1">
                    <div className="flex items-center space-x-2 md:space-x-3 bg-white rounded-lg px-2 py-1 border">
                      <button
                      ...
                      <span className="font-semibold w-6 md:w-8 text-center">
                        {product.quantity}
                      </span>
                      <button
        ...
        <div className="p-4 border-t bg-gray-50 rounded-b-2xl">
          <div className="flex justify-between items-center mb-3">
            <span className="ml-3 text-xl md:text-2xl font-semibold text-gray-700">
              Total del Pedido:
            </span>
            <span className="text-2xl md:text-3xl mr-3 font-bold text-brightColor">
          ...
          <button
            ...
            className="w-full bg-brightColor text-white py-3 md:py-4 px-6 rounded-xl hover:bg-opacity-90 transition-all flex items-center justify-center space-x-2 md:space-x-3 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 font-medium text-sm md:text-base"
          >
